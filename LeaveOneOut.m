...
MEASURES={'NDCG20' };
COLLECTIONS={'MQ09'};% 'CW12B' 'NTCIR' 'GOV2'  'WSJ' 'MQ07' 'MQ08' 'MQ09' };
%COLLECTIONS={ 'CW09B'};
...
%                                  Ytrain=Ytrain(~trainSetInx,:);
                     ...
                     %    end
                            ...
                            text(0.38,0.85,strcat(COLLECTIONS{coll},'-',STEMMERS{s}),'Units','normalized','FontSize',13)
                            ...
                            text(0.38,0.85,strcat(COLLECTIONS{coll},'-Sel',STEMMERS{s}),'Units','normalized','FontSize',13)
