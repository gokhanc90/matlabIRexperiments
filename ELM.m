function [TrainingTime, TestingTime, TrainingAccuracy, TestingAccuracy,Predictions] = ELM(TrainX,TrainY, TestX,TestY, Elm_Type, NumberofHiddenNeurons, ActivationFunction)
