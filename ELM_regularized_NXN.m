function [TrainingTime, TestingTime, test_sensitivity, test_specificity, test_gmean,Predictions] = ELM_regularized_NXN(TrainX,TrainY, TestX,TestY, Elm_Type, NumberofHiddenNeurons, ActivationFunction,C)
