function [TrainingTime, TestingTime, test_sensitivity, test_specificity, test_gmean,Predictions] = ELM_regularized_LXL(TrainX,TrainY, TestX,TestY, Elm_Type, NumberofHiddenNeurons, ActivationFunction,C)
...
%%%%%%%%%% Calculate training & testing classification accuracy
    ...
    FP=0;
    FN=0;
    Predictions=categorical(zeros(size(TV.T, 2),1));
    for i = 1 : size(TV.T, 2)
        ...
        Predictions(i)=categorical(label_index_actual-1);
    end
